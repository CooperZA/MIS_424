...
namespace _424_WebApp.Controllers
{
    ...
    public class ProductCategoriesController : Controller
    {
        ...
        {
            ViewBag.CategoryID = new SelectList(db.Categories, "CategoryID", "CatLabel");
            ViewBag.ProductID = new SelectList(db.Products, "ProductID", "ItemName");
            return View();
        }
        ...
        public ActionResult Create([Bind(Include = "ID,ProductID,CategoryID")] ProductCategory productCategory)
        {
            if (ModelState.IsValid)
            {
                ...
                {
                    TempData["message"] = $"That product/category comibination already exists.";
            ...
            ViewBag.CategoryID = new SelectList(db.Categories, "CategoryID", "CatLabel", productCategory.CategoryID);
            ViewBag.ProductID = new SelectList(db.Products, "ProductID", "ItemName", productCategory.ProductID);
            return View(productCategory);
        }
